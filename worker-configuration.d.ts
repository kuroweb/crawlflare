/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a9ad60158bd6bd6b980c437b2da4e0f)
// Runtime types generated with workerd@1.20251109.0 2025-09-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/app");
	}
	interface Env {
		...
		DB: D1Database;
		QUEUE_MERCARI_LIST: Queue;
		QUEUE_MERCARI_DETAIL: Queue;
		BROWSER: Fetcher;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "LOGIN_JWT_SECRET" | "BASIC_AUTH_USER" | "BASIC_AUTH_PASS">> {}
}
